...
export const MerchantOfflineSalesBlock: React.FC = () => {
    ...
    return (
        <div className="offline">
            <h6 className="offline__title">Offline sales</h6>
            <div className="offline__inner">
                <div className="offline__inner-left">
                    <div ref={svg} className="offline__inner-left__qr">
                        <QRCodeSVG
                ...
                <div className="offline__inner-right">
                    ...
                    <h6 className="offline__inner-right-title">How to use</h6>
                    <p className="offline__inner-right-point">
                        1. Download the QR code and place it in your store
                    </p>
                    <p className="offline__inner-right-point">
                        2. After scanning the QR code, the customer will be
                        redirected to a page, which awaits for the payment
                        creation. As soon as the seller creates the invoice, the
                        customer will automatically be redirected to the payment
                        form for the relevant invoice
                    </p>
                    <p className="offline__inner-right-point offline__inner-right-point--small">
                        Important: The system automatically redirects to the
                        last created unpaid invoice. If you already have a
                        pending invoice, create a new one before asking the

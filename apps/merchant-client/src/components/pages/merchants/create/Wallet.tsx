...
import {
    ReactComponent as LogoWalletConnect
} from '../../../../assets/logos/wallet-connect.svg'
import {
    ReactComponent as IconDelete
} from '../../../../assets/icons/delete.svg'
import {
    ReactComponent as IconSearch
...
const MerchantWallet: React.FC<FormProps> = ({
    onComplete
}) => {
    // replace with real data
    const wallets: Wallet[] = [
        { id: 1, icon: LogoWalletConnect, name: 'WalletConnect b', type: 'blockchain' },
        { id: 2, icon: LogoWalletConnect, name: 'WalletConnect', type: 'blockchain' },
        { id: 3, icon: LogoWalletConnect, name: 'WalletConnect', type: 'blockchain' },
        { id: 4, icon: LogoWalletConnect, name: 'WalletConnect', type: 'blockchain' },
        { id: 5, icon: LogoWalletConnect, name: 'WalletConnect', type: 'blockchain' },
        { id: 6, icon: LogoWalletConnect, name: 'WalletConnect', type: 'blockchain' },
        { id: 7, icon: LogoWalletConnect, name: 'WalletConnect', type: 'blockchain' },
        { id: 8, icon: LogoWalletConnect, name: 'WalletConnect', type: 'blockchain' },
        { id: 9, icon: LogoWalletConnect, name: 'WalletConnect', type: 'blockchain' },
        { id: 10, icon: LogoWalletConnect, name: 'WalletConnect w', type: 'wallet' },
        { id: 11, icon: LogoWalletConnect, name: 'WalletConnect', type: 'wallet' },
        { id: 12, icon: LogoWalletConnect, name: 'WalletConnect', type: 'wallet' },
        { id: 13, icon: LogoWalletConnect, name: 'WalletConnect', type: 'wallet' },
        { id: 14, icon: LogoWalletConnect, name: 'WalletConnect', type: 'wallet' },
        { id: 15, icon: LogoWalletConnect, name: 'WalletConnect', type: 'wallet' },
        { id: 16, icon: LogoWalletConnect, name: 'WalletConnect', type: 'wallet' },
        { id: 17, icon: LogoWalletConnect, name: 'WalletConnect', type: 'wallet' },
        { id: 18, icon: LogoWalletConnect, name: 'WalletConnect', type: 'wallet' },
        { id: 19, icon: LogoWalletConnect, name: 'WalletConnect e', type: 'exchange' },
        { id: 20, icon: LogoWalletConnect, name: 'WalletConnect', type: 'exchange' },
        { id: 21, icon: LogoWalletConnect, name: 'WalletConnect', type: 'exchange' },
        { id: 22, icon: LogoWalletConnect, name: 'WalletConnect', type: 'exchange' },
        { id: 23, icon: LogoWalletConnect, name: 'WalletConnect', type: 'exchange' },
        { id: 24, icon: LogoWalletConnect, name: 'WalletConnect', type: 'exchange' },
        { id: 25, icon: LogoWalletConnect, name: 'WalletConnect', type: 'exchange' },
        { id: 26, icon: LogoWalletConnect, name: 'WalletConnect', type: 'exchange' }
    ]
    ...
    const getConnectedItemsHTML = () => {
        return connected.map((el) => {
            ...
            return (
                <div
                    className="wallet__container-connected__item"
                    key={el.id}
                >
    ...
    const getWalletItemsHTML = () => {
        return walletsPaginated.map((el) => {
            ...
            return (
                <div
                    className="wallet__container-inner__item"
                    key={el.id}
                >
    ...
    return (
        <div className="wallet">
            <div className="wallet__header">
                <h4 className="wallet__header-title">
                    Add your wallets
                </h4>
                <p className="wallet__header-description">
                    Add a wallet, which will be used
            ...
            <div className="wallet__search">
                <PInput
                    ...
                    value={search}
                    prepend={
                        <IconSearch className="wallet__search-icon" />
                    }
            ...
            <div className="wallet__container">
                ...
                <div className="wallet__container-inner">
                    {walletItemsHTML}
                </div>
            </div>

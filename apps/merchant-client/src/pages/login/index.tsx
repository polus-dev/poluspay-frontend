import { Button, FormItem, Input, Link as LinkVk } from '@vkontakte/vkui/old';
...
export const LoginPage: React.FC<MainProps> = (props: MainProps) => {
    ...
    const inputEmail = new VldBuilder().with(vlds.VEmail).withFname('E-mail');

    const inputCode = new VldBuilder().with(vlds.VLen, 6, 6).withFname('Code');
    ...
    return (
        <div className="polus-login" id={props.id}>
                ...
                <div className="polus-login-block grey-block">
                    <div className="login-text-block">
                        ...
                        <div className="login-svg">
                            ...
                            <span>
                                No KYC, ID card, Bank Account required, just
                        ...
                        <div className="login-svg">
                            ...
                            <span>
                                Payments receives to your own wallet, service
                                didn't store any funds
                            </span>
                        </div>
                        <div className="login-svg">
                            <div className="login-img">
                            ...
                            <span>
                                Allows users to pay in multiple coins, merchant
                        ...
                        <div className="login-svg">
                            ...
                            <span>
                                No monthly fee, no withdrawal fee, only 0.5%
                                loyal processing fee
                            </span>
                        </div>
                    </div>
                </div>
            ...
            <div
                className="polus-login-block black-block"
                style={props.isDesktop ? {} : { width: '100%' }}
            >
                ...
                {loginPageType === 1 ? (
                    <form className="login-form">
                        <FormItem
                            top="E-mail"
                            bottom={inputEmail.error.slice(10)}
                        >
                            {' '}
                            {/* { NOTE: slice(10) - remove 'E-mail: '} */}
                            <Input
                                type="email"
                                placeholder="email@examle.com"
                                value={inputEmail.value.trim()}
                                onChange={(e) =>
                                    inputEmail.change(e.target.value)
                                }
                                onKeyDown={(e) =>
                                    e.key === 'Enter' &&
                                    inputEmail.iserr === 'valid'
                                        ? login()
                                        : null
                                }
                    ...
                    <div className="login-form">
                        ...
                        >
                            <Input
                                ...
                                onChange={(e) =>
                                    inputCode.change(e.target.value)
                                }
                                onKeyDown={(e) =>
                                    e.key === 'Enter' &&
                                    inputCode.iserr === 'valid'
                                        ? sendCode()
                                        : null
                                }

...
const MerchantWebhookHistoryResp = NewResponse(responses.merchant.webhook_history)
...
class MerchantRepo extends BasicRepo {
    ...
    public async webhook_history (data: MerchantWebhookHistory): RRes<MerchantWebhookHistoryRespType> {

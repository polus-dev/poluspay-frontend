...
const merchantInfo = t.type({
    ...
    webhook_error: t.string, // webhook error string
    ...
    webhook_status: t.union([ t.literal('active'), t.literal('error'), t.literal('closed') ])
})
...
type PResponse =
    ...
    | typeof responses.merchant.webhook_history
    // ----------------------------------

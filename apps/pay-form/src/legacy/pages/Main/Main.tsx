...
export const Main: React.FC<MainProps> = (props: MainProps) => {
    ...
    const { data: paymentInfo, isError: isGetPaymentInfoError } =
    ...
    if (!getParameterByName('uuid') || isGetPaymentInfoError || error) {
        return (
            <StatusComponent
                status="error"
                message={error ? error.message : 'payment uuid not found'}
            />
        );
        ...
        <>
            <Panel id="render">
                ...
                <ModalCurrencySelector
                    ...
                    assetsRepresentation={availableTokens}

...
import {blockchainList, ModalBlockChainSelector, ModalCurrencySelector} from "@poluspay-frontend/ui";
...
export const FormPayment = (props: FormPaymentProps) => {
  ...
  const currentBlockchain = useAppSelector(state => state.connection.currentBlockchain) || "Polygon"
  const item =  blockchainList.find(e => e.label === currentBlockchain) || blockchainList[0];
  return (
      <>
        <div className="payment">
            ...
            <div className="payment__currencies">
                <FormCurrencies openModal={modalCurrency.open} availableTokens={props.availableTokens} userToken={props.userToken} setUserToken={props.setUserToken}  />
            </div>
        ...
        <ModalBlockChainSelector
          ...
          options={blockchainList.filter(e => props.paymentAvailableBlockchains.includes(e.label))}
          setSelected={(e) => dispatch(setCurrentBlockchain(e.label))}
          selected={blockchainList.find(e => e.label === currentBlockchain)}
